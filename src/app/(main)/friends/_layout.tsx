        ...
        <View style={{ flex: 1 }}>
            <SubHeader>
                ...
                <SubLink
                    ...
                    onPress={() => {
                        !pathname.includes("/requests") && router.push("/friends/requests")
                    }}
                />
                <SubLink
                    text="Рекомендації"
                    ...
                    onPress={() => {
                        !pathname.includes("/recs") && router.push("/friends/recs")
                    }}
                />
                <SubLink
                    text="Всі друзі"
                    ...
                    onPress={() => {
                        !pathname.includes("/friends/all") && router.push("/friends/all")
                    }}
                />
            </SubHeader>
            <Stack screenOptions={{
